...
class siatka_potencjalu:
	...
	def rysuj(self, nazwa = '', draw = draw_chart, save = True):
		...
		ax_0.grid()
		ax_0.tick_params(labelsize = 'large')
		ax_0.xaxis.label.set_size(18)
		ax_0.xaxis.label.set_fontsize(20)
		ax_0.yaxis.label.set_size(18)
		ax_0.yaxis.label.set_fontsize(20)
		fig_0 = plt.gcf()
		...
		ax_z.grid()
		ax_z.tick_params(labelsize = 'large')
		ax_z.xaxis.label.set_size(18)
		ax_z.xaxis.label.set_fontsize(20)
		ax_z.yaxis.label.set_size(18)
		ax_z.yaxis.label.set_fontsize(20)
		fig_z = plt.gcf()
