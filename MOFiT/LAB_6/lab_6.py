...
class siatka:
	...
	def rysuj_strumien(self, nazwa):
		...
		ax.fill_between([95,105],51,70, color = 'gray')
		ax.grid()
		ax.set(ylabel = 'y', xlabel = 'x', title = '$\psi(x,y)$')
		ax.xaxis.label.set_size(18)
		ax.yaxis.label.set_size(18)
		ax.title.set_size(18)
		ax.get_figure().set_size_inches(18.5, 10.5, forward = False)

		fig_f, ax_f = plt.subplots()
		CS = ax_f.contourf(X, Y, V, 25, cmap = 'viridis')
		ax_f.fill_between([95,105],51,70, color = 'gray')
		...
		ax_f.get_figure().set_size_inches(18.5, 10.5, forward = False)
	...
	def rysuj_potencjal(self, nazwa):
		...
		C = ax.contour(X, Y, V, levels = 9, cmap = 'viridis')
		ax.clabel(C, inline=1, fontsize=10)
		ax.fill_between([95,105],51,70, color = 'gray')
		...
		fig_f, ax_f = plt.subplots()
		CS = ax_f.contourf(X, Y, V, levels = 9, cmap = 'viridis')
		ax_f.fill_between([95,105],51,70, color = 'gray')
		cb_f = fig_f.colorbar(CS)
		ax_f.grid()
